...
<body>
    ...
    <div class="container">
        ...
        $stmt = $conn->query("SELECT * FROM delivery_inc");
        ...
        <form id="deliveryForm" action="/inv/incoming" method="POST" enctype="multipart/form-data">
            <h3>Add Incoming Stocks</h3>
            <div class="form-group">
                <label for="image">Image:</label>
                <input type="file" id="image" name="image"><br>
                <label for="delivery_id">Delivery ID:</label>
                <input type="number" id="delivery_id" name="delivery_id" required><br>
