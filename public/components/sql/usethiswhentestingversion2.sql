...
(6, 4, 2, 'uploads/Cement_(50kg).png', 'Cement (50kg)', 'Girlsen', 'Portland cement for construction purposes', 'Building Materials', NULL, 240.00, 160.00, NULL, 'pcs', 0.12, 50.00, '', 'Available'),
...
(14, 4, 2, 'uploads/Roofing_Shingles_(Bundle).png', 'Roofing Shingles (Bundle)', 'Girlsen', 'Bundle of roofing shingles for covering roofs', 'Building Materials', NULL, 1750.00, 1360.00, NULL, 'bundle', 0.12, 13.61, '', 'Available'),
(15, 4, 2, 'uploads/Sand_(1_cubic_yard).jpg', 'Sand (1 cubic yard)', 'Girlsen', 'Fine aggregate sand for various construction applications', 'Building Materials', NULL, 1500.00, 1250.00, NULL, 'cubic yard', 0.12, 1088.62, '', 'Available'),
(16, 4, 2, 'uploads/Brick_(Standard).png', 'Brick (Standard)', 'Girlsen', 'Standard clay bricks for construction', 'Building Materials', NULL, 12.00, 7.00, NULL, 'pcs', 0.12, 2.50, '', 'Available'),
(17, 4, 1, 'uploads/Wood_Studs_(8_feet).png', 'Wood Studs (8 feet)', 'Girlsen', 'Standard wood studs for framing walls', 'Tools', NULL, 225.00, 196.00, NULL, '8 feet', 0.12, 3.63, '', 'Available'),
(18, 5, 2, 'uploads/Galvanized_Nails_(5_lbs).png', 'Galvanized Nails (5 lbs)', 'Edward Shop', 'Galvanized nails for various construction applicat...', 'Building Materials', NULL, 50.00, 24.00, NULL, 'lbs', 0.12, 2.27, '', 'Available'),
(19, 5, 2, 'uploads/Drywall_(4x8_feet).png', 'Drywall (4x8 feet)', 'Edward Shop', 'Drywall sheets for interior wall finishing', 'Building Materials', NULL, 450.00, 395.00, NULL, 'sheet', 0.12, 22.68, '', 'Available'),
(20, 5, 2, 'uploads/Concrete_Mix_(50_lb).png', 'Concrete Mix (50 lb)', 'Edward Shop', 'Pre-mixed concrete for small-scale construction projects', 'Building Materials', NULL, 365.00, 315.00, NULL, 'lb', 0.12, 18.68, '', 'Available'),
(21, 5, 1, 'uploads/Adjustable_Wrench_(12_inches).png', 'Adjustable Wrench (12 inches)', 'Edward Shop', 'Adjustable wrench for plumbing and mechanical work', 'Tools', NULL, 115.00, 107.00, NULL, 'pcs', 0.12, 1.20, '', 'Available'),
(22, 5, 1, 'uploads/Electric_Screwdriver.png', 'Electric Screwdriver', 'Edward Shop', 'Electric screwdriver with multiple torque settings', 'Tools', NULL, 269.00, 253.00, NULL, 'pcs', 0.12, 1.80, '', 'Available'),
...
(27, 5, 5, 'uploads/Oil_Paint_Set.png', 'Oil Paint Set', 'Edward Shop', 'Set of high-quality oil paints for professional artists', 'Paints and Chemicals', NULL, 129.00, 97.00, NULL, 'set', 0.12, 0.80, '', 'Available'),
(28, 5, 3, 'uploads/Sketching_Pencils_(Set_of_12).png', 'Sketching Pencils (Set of 12)', 'Edward Shop', 'Set of graphite sketching pencils for drawing and ...', 'Art Supplies', NULL, 45.00, 25.00, NULL, 'set', 0.12, 0.30, '', 'Available'),
(29, 5, 3, 'uploads/Canvas_Roll_(6_feet).png', 'Canvas Roll (6 feet)', 'Edward Shop', 'Roll of primed canvas for painting', 'Art Supplies', NULL, 40.00, 29.00, NULL, 'roll', 0.12, 3.00, '', 'Available'),
...
(32, 6, 4, 'uploads/Reflective_Safety_Tape_(Roll).png', 'Reflective Safety Tape (Roll)', 'Kobe Shop', 'Roll of reflective tape for enhancing visibility on safety gear', 'Safety Gear', NULL, 40.00, 25.00, NULL, 'roll', 0.12, 0.20, '', 'Available'),
(33, 6, 2, 'uploads/Wood_Stain_(1_quart).jpg', 'Wood Stain (1 quart)', 'Kobe Shop', 'High-quality wood stain for finishing wood surface...', 'Building Materials', NULL, 215.00, 185.00, NULL, 'quart', 0.12, 2.00, '', 'Available'),
(34, 6, 1, 'uploads/Paint_Roller_Set.png', 'Paint Roller Set', 'Kobe Shop', 'Set of paint rollers for applying paint smoothly on surfaces', 'Tools', NULL, 300.00, 280.00, NULL, 'set', 0.12, 0.80, '', 'Available'),
(35, 6, 5, 'uploads/Adhesive_Primer_(1_gallon).png', 'Adhesive Primer (1 gallon)', 'Kobe Shop', 'Adhesive primer for preparing surfaces before pain...', 'Paints and Chemicals', NULL, 210.00, 190.00, NULL, 'gallon', 0.12, 8.00, '', 'Available');
