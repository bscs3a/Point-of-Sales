...
<script>
  ...
  <span class="mt-4 flex">
    ...
    <button route="/hr/leave-requests/reviewed" type="submit" class="focus:outline-none text-white bg-yellow-400 hover:bg-yellow-500 focus:ring-4 focus:ring-yellow-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:focus:ring-yellow-900">Approve</button>
    </form>
    <form action="/master/deny/leave-requests" method="POST">
    <button route="/hr/leave-requests/reviewed" type="submit" class="focus:outline-none text-gray-700 bg-white hover:bg-gray-100 focus:ring-4 focus:ring-yellow-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:focus:ring-yellow-900">Deny</button>
    </form>
  </span>
  </div>
  </div>
