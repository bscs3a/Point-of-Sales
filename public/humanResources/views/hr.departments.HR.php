<?php
  ...
  $countQuery = "SELECT COUNT(*) FROM employees WHERE department = 'Human Resources'";
  $params = [];
    ...
    <div class="hidden sm:block">
        <div class="border-b border-gray-200">
            <nav class="-mb-px flex flex-wrap gap-6" aria-label="Tabs">
                <a route="/hr/departments/product-order/page=1"
...
<div class="flex flex-wrap">
  ...
  <form action="/hr/departments/human-resources/page=1" method="POST" class="mt-6 ml-auto mr-4 flex">
...
<?php 
// PUT YOUR LINK HERE
$link = "/hr/departments/human-resources/page=";
?>
