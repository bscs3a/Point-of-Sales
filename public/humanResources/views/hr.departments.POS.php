<?php
  ...
  $countQuery = "SELECT COUNT(*) FROM employees WHERE department = 'Point of Sales'";
  $params = [];
...
<div class="flex flex-wrap">
    ...
    <form action="/hr/departments/sales/page=1" method="POST" class="mt-6 ml-auto mr-4 flex">
...
<?php 
// PUT YOUR LINK HERE
$link = "/hr/departments/sales/page=";
?>
