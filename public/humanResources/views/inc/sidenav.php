...
<!-- Audit Trail -->
<li class="mb-1 group">
  <a route="/hr/audit/page=1" class="flex items-center py-2 px-4 text-gray-50 hover:bg-gray-950 hover:text-gray-100 rounded-md group-[.active]:bg-gray-800 group-[.active]:text-white group-[.selected]:bg-gray-950 group-[.selected]:text-gray-100">
    <i class="ri-calendar-schedule-line mr-3 text-lg"></i>
