                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 md:grid-cols-3 gap-6 ">
                    ...
                    <div class=" col-span-1 bg-gradient-to-b from-[#F8B721] to-[#FBCF68] rounded-xl drop-shadow-md">
                        <div class="mx-5 my-5 py-3 px-3 text-white">
                            ...
                            <p class="mt-5 text-4xl font-medium">₱9,541.00</p>
                        </div>
                    </div>
                    <div class=" col-span-1 bg-gradient-to-b from-[#F8B721] to-[#FBCF68] rounded-xl drop-shadow-md">
                        <div class="mx-5 my-5 py-3 px-3 text-white">
                            <h1 class="text-3xl font-bold">Remaining Funds</h1>
                            <p class="mt-5 text-4xl font-medium">₱40,459.00</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="overflow-x-auto rounded-lg border border-gray-400">
                <table class="min-w-full divide-y-2 divide-gray-400 bg-white text-sm">
                    ...
                    <tbody class="divide-y divide-gray-200 text-center">
                        <tr>
                            <td class="whitespace-nowrap px-4 py-2 text-gray-700">0005</td>
                            <td class="whitespace-nowrap px-4 py-2 text-gray-700">New Equipment</td>
                            <td class="whitespace-nowrap px-4 py-2 text-gray-700">₱6,000.00</td>
                            <td class="whitespace-nowrap px-4 py-2 text-gray-700">Inventory</td>
                            <td class="whitespace-nowrap px-4 py-2 text-gray-700">April 3, 2024</td>
                        </tr>
                        <tr>
                            <td class="whitespace-nowrap px-4 py-2 text-gray-700">0008</td>
                            <td class="whitespace-nowrap px-4 py-2 text-gray-700">Operational & Maintenance Cost</td>
                            <td class="whitespace-nowrap px-4 py-2 text-gray-700">₱1,500.00</td>
                            <td class="whitespace-nowrap px-4 py-2 text-gray-700">Inventory</td>
                            <td class="whitespace-nowrap px-4 py-2 text-gray-700">April 6, 2024</td>
                        </tr>
                        <tr>
                            <td class="whitespace-nowrap px-4 py-2 text-gray-700">0012</td>
                            <td class="whitespace-nowrap px-4 py-2 text-gray-700">Excess Stock Cost</td>
                            <td class="whitespace-nowrap px-4 py-2 text-gray-700">₱892.00</td>
                            <td class="whitespace-nowrap px-4 py-2 text-gray-700">Inventory</td>
                            <td class="whitespace-nowrap px-4 py-2 text-gray-700">April 8, 2024</td>
                        </tr>
                        <tr>
                            <td class="whitespace-nowrap px-4 py-2 text-gray-700">0016</td>
                            <td class="whitespace-nowrap px-4 py-2 text-gray-700">New Equipment</td>
                            <td class="whitespace-nowrap px-4 py-2 text-gray-700">₱1,149.00</td>
                            <td class="whitespace-nowrap px-4 py-2 text-gray-700">Inventory</td>
