...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Jun 02, 2024 at 03:33 PM
...
(4, 3, '21:19:20', '2024-06-02', 450, 194785, 'Completed', 'Cash on bank', 13),
(5, 4, '21:19:56', '2024-06-02', 400, 225055, 'Completed', 'Cash on bank', 14),
(6, 5, '21:20:41', '2024-06-02', 450, 78040, 'Completed', 'Cash on bank', 15),
(7, 6, '21:21:20', '2024-06-02', 200, 34100, 'Completed', 'Cash on bank', 16),
(8, 2, '21:25:07', '2024-06-02', 253, 40733, 'Completed', 'Cash on bank', 17),
(9, 2, '21:25:45', '2024-06-02', 4, 285, 'Completed', 'Cash on bank', 18);
...
(29, 32, '2024-05-30 15:13:47', 4, 20000000, 'Investment of 32 in 4 with 20000000'),
(30, 32, '2024-05-30 15:13:59', 6, 1000000, 'Investment of 32 in 6 with 1000000'),
(31, 32, '2024-05-30 15:18:31', 4, 100000000, 'Investment of 32 in 4 with 100000000'),
(32, 4, '2024-06-02 15:19:20', 6, 194785, 'Pondo expense for Product Order'),
(33, 4, '2024-06-02 15:19:56', 6, 225055, 'Pondo expense for Product Order'),
(34, 4, '2024-06-02 15:20:41', 6, 78040, 'Pondo expense for Product Order'),
(35, 4, '2024-06-02 15:21:20', 6, 34100, 'Pondo expense for Product Order'),
(36, 4, '2024-06-02 15:25:07', 6, 40733, 'Pondo expense for Product Order'),
(37, 4, '2024-06-02 15:25:45', 6, 285, 'Pondo expense for Product Order');
...
(20, 4, 3, 4, 50, '21:19:20', '2024-06-02'),
(21, 5, 3, 4, 50, '21:19:20', '2024-06-02'),
(22, 8, 3, 4, 50, '21:19:20', '2024-06-02'),
(23, 9, 3, 4, 50, '21:19:20', '2024-06-02'),
(24, 10, 3, 4, 50, '21:19:20', '2024-06-02'),
(25, 11, 3, 4, 50, '21:19:20', '2024-06-02'),
(26, 12, 3, 4, 50, '21:19:20', '2024-06-02'),
(27, 30, 3, 4, 50, '21:19:20', '2024-06-02'),
(28, 31, 3, 4, 50, '21:19:20', '2024-06-02'),
(29, 6, 4, 5, 100, '21:19:56', '2024-06-02'),
(30, 14, 4, 5, 100, '21:19:56', '2024-06-02'),
(31, 15, 4, 5, 50, '21:19:56', '2024-06-02'),
(32, 16, 4, 5, 100, '21:19:56', '2024-06-02'),
(33, 17, 4, 5, 50, '21:19:56', '2024-06-02'),
(34, 18, 5, 6, 50, '21:20:41', '2024-06-02'),
(35, 19, 5, 6, 50, '21:20:41', '2024-06-02'),
(36, 20, 5, 6, 100, '21:20:41', '2024-06-02'),
(37, 21, 5, 6, 50, '21:20:41', '2024-06-02'),
(38, 22, 5, 6, 50, '21:20:41', '2024-06-02'),
(39, 27, 5, 6, 50, '21:20:41', '2024-06-02'),
(40, 28, 5, 6, 50, '21:20:41', '2024-06-02'),
(41, 29, 5, 6, 50, '21:20:41', '2024-06-02'),
(42, 32, 6, 7, 50, '21:21:20', '2024-06-02'),
(43, 33, 6, 7, 50, '21:21:20', '2024-06-02'),
(44, 34, 6, 7, 50, '21:21:20', '2024-06-02'),
(45, 35, 6, 7, 50, '21:21:20', '2024-06-02'),
(46, 3, 2, 8, 3, '21:25:07', '2024-06-02'),
(47, 7, 2, 8, 50, '21:25:07', '2024-06-02'),
(48, 13, 2, 8, 50, '21:25:07', '2024-06-02'),
(49, 23, 2, 8, 50, '21:25:07', '2024-06-02'),
(50, 24, 2, 8, 50, '21:25:07', '2024-06-02'),
(51, 25, 2, 8, 50, '21:25:07', '2024-06-02'),
(52, 2, 2, 9, 4, '21:25:45', '2024-06-02');
...
(2, 2, 3, 'uploads/Acrylic_Paint_Set.png', 'Acrylic Paint Set', 'MRS DIY', 'Set of vibrant acrylic paints suitable for various surfaces', 'Art Supplies', 'No', 99.00, 65.00, 100, 'pcs', 0.12, 0.70, '', 'Available'),
(3, 2, 2, 'uploads/Adjustable_Wrench_(12_inches).png', 'Adjustable Wrench (12 inches)', 'MRS DIY', 'Adjustable wrench for plumbing and mechanical work', 'Tools', 'No', 109.00, 86.00, 100, 'pcs', 0.12, 1.20, '', 'Not Available'),
(4, 3, 1, 'uploads/Hammer_(Large).png', 'Hammer (Large)(Large)', 'MR DIY', 'Heavy-duty hammer for construction work', 'Tools', 'No', 329.00, 260.00, 50, 'pcs', 0.12, 1.50, '', 'Available'),
(5, 3, 1, 'uploads/Screwdriver_Set_(Standard).png', 'Screwdriver Set (Standard)', 'MR DIY', 'Set of 6 screwdrivers with various sizes', 'Tools', 'No', 969.00, 670.00, 50, 'set', 0.12, 0.80, '', 'Available'),
(6, 4, 2, 'uploads/Cement_(50kg).png', 'Cement (50kg)', 'Girlsen', 'Portland cement for construction purposes', 'Building Materials', 'Yes', 240.00, 160.00, 100, 'pcs', 0.12, 50.00, '', 'Available'),
(7, 2, 3, 'uploads/Paint_Brush_Set.png', 'Paint Brush Set', 'MRS DIY', 'Set of 10 paint brushes for art projects', 'Art Supplies', 'No', 209.00, 180.00, 50, 'set', 0.12, 0.50, '', 'Available'),
(8, 3, 4, 'uploads/Safety_Helmet.png', 'Safety Helmet', 'MR DIY', 'Hard hat helmet for construction safety', 'Safety Gear', 'No', 470.00, 415.00, 50, 'pcs', 0.12, 0.30, '', 'Available'),
(9, 3, 1, 'uploads/drill machine.jpg', 'Drill Machine', 'MR DIY', 'Cordless drill machine with rechargeable batteries', 'Tools', 'No', 1100.00, 860.00, 50, 'pcs', 0.12, 2.00, '', 'Available'),
(10, 3, 2, 'uploads/Plywood (4x8 feet).jpg', 'Plywood (4x8 feet)', 'MR DIY', 'Plywood sheets for carpentry and construction', 'Building Materials', 'Yes', 650.00, 560.00, 50, 'sheet', 0.12, 20.00, '', 'Available'),
(11, 3, 2, 'uploads/Steel_Bar_(1_meter).png', 'Steel Bar (1 meter)', 'MR DIY', 'Deformed steel bars for reinforcement in concrete ...', 'Building Materials', 'Yes', 55.00, 35.00, 50, 'meter', 0.12, 2.50, '', 'Available'),
(12, 3, 2, 'uploads/Concrete Blocks (Standard).jpg', 'Concrete Blocks (Standard)', 'MR DIY', 'Standard concrete blocks for building walls', 'Building Materials', 'Yes', 12.00, 8.00, 50, 'pcs', 0.12, 2.30, '', 'Available'),
(13, 2, 5, 'uploads/Paint_Thinner.png', 'Paint Thinner', 'MRS DIY', 'Solvent used for thinning oil-based paints and cleaning paint brushes', 'Paints and Chemicals', 'No', 170.00, 135.00, 50, 'pcs', 0.12, 1.00, '', 'Available'),
(14, 4, 2, 'uploads/Roofing_Shingles_(Bundle).png', 'Roofing Shingles (Bundle)', 'Girlsen', 'Bundle of roofing shingles for covering roofs', 'Building Materials', 'Yes', 1750.00, 1360.00, 100, 'bundle', 0.12, 13.61, '', 'Available'),
(15, 4, 2, 'uploads/Sand_(1_cubic_yard).jpg', 'Sand (1 cubic yard)', 'Girlsen', 'Fine aggregate sand for various construction applications', 'Building Materials', 'Yes', 1500.00, 1250.00, 50, 'cubic yard', 0.12, 1088.62, '', 'Available'),
(16, 4, 2, 'uploads/Brick_(Standard).png', 'Brick (Standard)', 'Girlsen', 'Standard clay bricks for construction', 'Building Materials', 'Yes', 12.00, 7.00, 100, 'pcs', 0.12, 2.50, '', 'Available'),
(17, 4, 2, 'uploads/Wood_Studs_(8_feet).png', 'Wood Studs (8 feet)', 'Girlsen', 'Standard wood studs for framing walls', 'Building Materials', 'Yes', 225.00, 196.00, 50, '8 feet', 0.12, 3.63, '', 'Available'),
(18, 5, 2, 'uploads/Galvanized_Nails_(5_lbs).png', 'Galvanized Nails (5 lbs)', 'Edward Shop', 'Galvanized nails for various construction applicat...', 'Building Materials', 'Yes', 50.00, 24.00, 50, 'lbs', 0.12, 2.27, '', 'Available'),
(19, 5, 2, 'uploads/Drywall_(4x8_feet).png', 'Drywall (4x8 feet)', 'Edward Shop', 'Drywall sheets for interior wall finishing', 'Building Materials', 'Yes', 450.00, 395.00, 50, 'sheet', 0.12, 22.68, '', 'Available'),
(20, 5, 2, 'uploads/Concrete_Mix_(50_lb).png', 'Concrete Mix (50 lb)', 'Edward Shop', 'Pre-mixed concrete for small-scale construction projects', 'Building Materials', 'Yes', 365.00, 315.00, 100, 'lb', 0.12, 18.68, '', 'Available'),
(21, 5, 1, 'uploads/Adjustable_Wrench_(12_inches).png', 'Adjustable Wrench (12 inches)', 'Edward Shop', 'Adjustable wrench for plumbing and mechanical work', 'Tools', 'No', 115.00, 107.00, 50, 'pcs', 0.12, 1.20, '', 'Available'),
(22, 5, 1, 'uploads/Electric_Screwdriver.png', 'Electric Screwdriver', 'Edward Shop', 'Electric screwdriver with multiple torque settings', 'Tools', 'No', 269.00, 253.00, 50, 'pcs', 0.12, 1.80, '', 'Available'),
(23, 2, 2, 'uploads/PVC_Pipes_(10_feet).png', 'PVC Pipes (10 feet)', 'MRS DIY', 'PVC pipes for plumbing and drainage systems', 'Building Materials', 'Yes', 42.00, 38.00, 50, 'feet', 0.12, 6.00, '', 'Available'),
(24, 2, 2, 'uploads/Insulation_Foam_Board_(4x8_feet).png', 'Insulation Foam Board (4x8 feet)', 'MRS DIY', 'Foam boards for insulation purposes in construction', 'Building Materials', 'Yes', 380.00, 369.00, 50, 'sheet', 0.12, 12.00, '', 'Available'),
(25, 2, 3, 'uploads/Watercolor_Paint_Set.png', 'Watercolor Paint Set', 'MRS DIY', 'Set of high-quality watercolor paints for artists', 'Art Supplies', 'No', 109.00, 87.00, 50, 'set', 0.12, 0.60, '', 'Available'),
(27, 5, 5, 'uploads/Oil_Paint_Set.png', 'Oil Paint Set', 'Edward Shop', 'Set of high-quality oil paints for professional artists', 'Paints and Chemicals', 'No', 129.00, 97.00, 50, 'set', 0.12, 0.80, '', 'Available'),
(28, 5, 3, 'uploads/Sketching_Pencils_(Set_of_12).png', 'Sketching Pencils (Set of 12)', 'Edward Shop', 'Set of graphite sketching pencils for drawing and ...', 'Art Supplies', 'No', 45.00, 25.00, 50, 'set', 0.12, 0.30, '', 'Available'),
(29, 5, 3, 'uploads/Canvas_Roll_(6_feet).png', 'Canvas Roll (6 feet)', 'Edward Shop', 'Roll of primed canvas for painting', 'Art Supplies', 'Yes', 40.00, 29.00, 50, 'roll', 0.12, 3.00, '', 'Available'),
(30, 3, 4, 'uploads/Hard_Hat_with_Ear_Protection.png', 'Hard Hat with Ear Protection', 'MR DIY', 'Safety hard hat with built-in ear protection for noisy environments', 'Safety Gear', 'No', 305.00, 287.00, 50, 'pcs', 0.12, 0.50, '', 'Available'),
(31, 3, 4, 'uploads/Steel-Toed_Boots.png', 'Steel-Toed Boots', 'MR DIY', 'Heavy-duty steel-toed boots for foot protection in...', 'Safety Gear', 'No', 799.00, 800.00, 50, 'pair', 0.12, 2.00, '', 'Available'),
(32, 6, 4, 'uploads/Reflective_Safety_Tape_(Roll).png', 'Reflective Safety Tape (Roll)', 'Kobe Shop', 'Roll of reflective tape for enhancing visibility on safety gear', 'Safety Gear', 'No', 40.00, 25.00, 50, 'roll', 0.12, 0.20, '', 'Available'),
(33, 6, 2, 'uploads/Wood_Stain_(1_quart).jpg', 'Wood Stain (1 quart)', 'Kobe Shop', 'High-quality wood stain for finishing wood surface...', 'Building Materials', 'No', 215.00, 185.00, 50, 'quart', 0.12, 2.00, '', 'Available'),
(34, 6, 3, 'uploads/Paint_Roller_Set.png', 'Paint Roller Set', 'Kobe Shop', 'Set of paint rollers for applying paint smoothly on surfaces', 'Tools', 'No', 300.00, 280.00, 50, 'set', 0.12, 0.80, '', 'Available'),
(35, 6, 5, 'uploads/Adhesive_Primer_(1_gallon).png', 'Adhesive Primer (1 gallon)', 'Kobe Shop', 'Adhesive primer for preparing surfaces before pain...', 'Paints and Chemicals', 'No', 210.00, 190.00, 50, 'gallon', 0.12, 8.00, '', 'Available');
...
(2, 'MRS DIY', 'Do it yourself', '091238578', 'Active', 'mrsdiy@gmail.com', 'Nueva Ecija', '5 - 7 days', '25', 'Monday - Friday'),
...
(4, 4, 3, '2024-06-02', '21:19:27', 'Completed', NULL),
(5, 5, 4, '2024-06-02', '21:19:59', 'Completed', NULL),
(6, 6, 5, '2024-06-02', '21:20:54', 'Completed', NULL),
(7, 7, 6, '2024-06-02', '21:21:23', 'Completed', NULL),
(8, 8, 2, '2024-06-02', '21:25:12', 'Completed', NULL),
(9, 9, 2, '2024-06-02', '21:25:49', 'Completed', NULL);
