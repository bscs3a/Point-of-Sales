...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Jun 02, 2024 at 12:00 PM
...
(17, 4, 1, 'uploads/Wood_Studs_(8_feet).png', 'Wood Studs (8 feet)', 'Girlsen', 'Standard wood studs for framing walls', 'Tools', NULL, 225.00, 196.00, 100, '8 feet', 0.12, 3.63, '', 'Available'),
...
(21, 5, 1, 'uploads/Adjustable_Wrench_(12_inches).png', 'Adjustable Wrench (12 inches)', 'Edward Shop', 'Adjustable wrench for plumbing and mechanical work', 'Tools', NULL, 115.00, 107.00, 50, 'pcs', 0.12, 1.20, '', 'Available'),
(22, 5, 1, 'uploads/Electric_Screwdriver.png', 'Electric Screwdriver', 'Edward Shop', 'Electric screwdriver with multiple torque settings', 'Tools', NULL, 269.00, 253.00, 50, 'pcs', 0.12, 1.80, '', 'Available'),
...
(34, 6, 1, 'uploads/Paint_Roller_Set.png', 'Paint Roller Set', 'Kobe Shop', 'Set of paint rollers for applying paint smoothly on surfaces', 'Tools', NULL, 300.00, 280.00, 50, 'set', 0.12, 0.80, '', 'Available'),
...
--
ALTER TABLE `ledgertransaction`
  MODIFY `LedgerXactID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;
